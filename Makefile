LANGUAGE_NAME := tree-sitter-glimmer
HOMEPAGE_URL := https://github.com/ember-tooling/tree-sitter-glimmer
VERSION := 1.4.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/glimmer '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/glimmer
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/glimmer
